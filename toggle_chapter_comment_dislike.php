<?php
    ...
    if(isset($chapter_comment_id) && !empty($chapter_comment_id) && is_numeric($chapter_comment_id) && isset($user_id) && !empty($user_id) && is_numeric($user_id))
    {
        ...
        try
        {
            ...
            // Binding
            $get_user_dislike_ids->bindValue(":comment_id", $chapter_comment_id);
            ...
            if($user_dislike_ids != null && $user_dislike_ids != "")
            {
                ...
                if(str_contains($user_dislike_ids, $user_id))
                {
                    ...
                    // Binding
                    $decrease_dislikes_number->bindValue(":comment_id", $chapter_comment_id);
                ...
                else if(!str_contains($user_dislike_ids, $user_id))
                {
                    ...
                    // Binding
                    $increase_dislikes_number->bindValue(":comment_id", $chapter_comment_id);
        ...
        catch(Exception $exc)
        {
            ...
            // Show error
            echo "<p>Exception caught during chapter comment dislike toggling : ".$exc->getMessage().".</p>";
